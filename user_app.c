...
void UserAppInitialize(void)
{
    ...
    /*Timer0 control register initialization - turn timer0 on, asynch mode, 16 bit, 1:1 postscaler,
    1:16 prescaler*, Fosc/4 CS*/
    T0CON0 = 0x90;
    T0CON1 = 0x54;
...
void UserAppRun(void)
{
    ...
    /* u8Index rolls-over to 0 after reaching 256 */
    u8Index+=4;
} /* end UserAppRun */
...
void TimeXus ( u16 u16Microseconds )
{
    ...
    /* Preload TMR0H and TMR0L based on u16Microseconds */
    TMR0H = (0xffff - u16Microseconds) >> 8;
    TMR0L = ( ( 0xffff - u16Microseconds ) << 8 ) >> 8;
